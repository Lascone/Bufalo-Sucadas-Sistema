      ...
      >
        ...
        >
          <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
            <h3 className="font-semibold text-ink-50">Trocar usuário</h3>
            <button
              type="button"
          ...
          <OperatorPicker
            compact
            title="Quem está usando agora?"
            subtitle="Escolha quem está assumindo o sistema."
            onSelect={(selected) => {
              setOperator(selected.id);
              setShowSwitchModal(false);
            }}
          />
          <div className="border-t border-white/10 px-4 py-2.5 flex justify-end">
            <button
              type="button"
            ...
            >
              ...
              Desconectar e voltar para tela inicial
            </button>
          </div>
        </div>
      </div>
