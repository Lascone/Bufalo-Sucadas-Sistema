...
CREATE TABLE "warehouses" (
    ...
    "locationNote" TEXT,
    "active" BOOLEAN NOT NULL DEFAULT true,
    CONSTRAINT "warehouses_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "devices" (
    ...
    "blockedReason" TEXT,
    "appVersion" TEXT,
    CONSTRAINT "devices_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "contact_contact_types" (
    ...
    CONSTRAINT "contact_contact_types_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "contacts" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "contact_contact_types_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "contact_types" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "material_categories" (
    ...
    "description" TEXT,
    "active" BOOLEAN NOT NULL DEFAULT true,
    CONSTRAINT "material_categories_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "materials" (
    ...
    CONSTRAINT "materials_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "material_categories" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "material_prices" (
    ...
    "validTo" DATETIME,
    CONSTRAINT "material_prices_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "materials" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "company_price_tables" (
    ...
    "contactId" TEXT NOT NULL,
    "materialId" TEXT NOT NULL,
    "negotiatedPrice" DECIMAL NOT NULL,
    "validFrom" DATETIME NOT NULL,
    "validTo" DATETIME,
    "minQuantity" DECIMAL,
    ...
    "notes" TEXT,
    CONSTRAINT "company_price_tables_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "contacts" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "company_price_tables_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "materials" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "purchases" (
    ...
    "surchargeTotal" DECIMAL NOT NULL DEFAULT 0,
    ...
    CONSTRAINT "purchases_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES "contacts" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "purchases_warehouseId_fkey" FOREIGN KEY ("warehouseId") REFERENCES "warehouses" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "purchase_items" (
    ...
    CONSTRAINT "purchase_items_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "materials" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "weighings" (
    ...
    "tareWeight" DECIMAL NOT NULL DEFAULT 0,
    ...
    CONSTRAINT "weighings_purchaseId_fkey" FOREIGN KEY ("purchaseId") REFERENCES "purchases" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "sales" (
    ...
    CONSTRAINT "sales_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "contacts" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "sale_items" (
    ...
    CONSTRAINT "sale_items_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "materials" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "stock_processing" (
    ...
    "sourceWeight" DECIMAL NOT NULL,
    "resultPayload" JSONB NOT NULL,
    "lossWeight" DECIMAL NOT NULL DEFAULT 0,
...
CREATE TABLE "financial_accounts" (
    ...
    "accountNumber" TEXT,
    "active" BOOLEAN NOT NULL DEFAULT true,
    CONSTRAINT "financial_accounts_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "financial_transactions" (
    ...
    CONSTRAINT "financial_transactions_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "financial_accounts" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "company_credits" (
    ...
    "blocked" BOOLEAN NOT NULL DEFAULT false,
    "expiresAt" DATETIME,
    CONSTRAINT "company_credits_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "contacts" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "company_credit_movements" (
    ...
    "notes" TEXT,
    "movedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "company_credit_movements_creditId_fkey" FOREIGN KEY ("creditId") REFERENCES "company_credits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "cash_register_movements" (
    ...
    "sourceDocumentId" TEXT,
    "movedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "cash_register_movements_cashRegisterId_fkey" FOREIGN KEY ("cashRegisterId") REFERENCES "cash_registers" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "sync_logs" (
    ...
    "details" JSONB,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "sync_logs_deviceId_fkey" FOREIGN KEY ("deviceId") REFERENCES "devices" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "application_settings" (
    ...
    "description" TEXT,
    CONSTRAINT "application_settings_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
